...
function App() {
  ...
  /* Highlight chip as each section enters the viewport */
  useEffect(() => {
  ...
  return (
    <div className="landing">
      ...
      {/* Main navbar — always same colour, never transforms */}
      ...
      {/* Second navbar — fixed below main, transparent, section chips */}
      ...
      <section className="viz-section">
        <div className="section-wrap">
          ...
          <h2 className="viz-headline">
            Track and manage ingredients,<br />
            explore cooking variations, and<br />
          ...
          <div className="viz-cards">
            <div className="viz-card vc-green">
              ...
              <h3>Type It In</h3>
              <p>Quickly log what's in your kitchen by typing items and quantities. Your inventory updates instantly.</p>
            ...
            <div className="viz-card vc-teal">
              ...
              <h3>Snap &amp; Detect</h3>
              <p>Point your camera at the fridge or pantry. Our vision model identifies and counts your ingredients automatically.</p>
            ...
            <div className="viz-card vc-dark">
              <div className="vc-icon-wrap"><span>🎙️</span></div>
              <h3>Just Say It</h3>
              <p>Tell RecipeGen what's in your kitchen out loud. ElevenLabs converts your voice into a structured ingredient list in seconds.</p>
          ...
          {/* Inventory confirmation strip */}
          <div className="viz-confirm-strip">
            <span className="vcs-icon">🔍</span>
            <div>
              <strong>You're always in control.</strong>
              <span> Review and correct your inventory before any recipe is generated — because you know your kitchen best.</span>
            </div>
          </div>
      ...
      <section id="how-it-works" className="hiw-section">
        <div className="hiw-wrap">
          ...
          <div className="hiw-header">
            ...
            <h2 className="hiw-title">From empty fridge<br />to perfect plate.</h2>
            <p className="hiw-sub">RecipeGen handles everything — ingredient detection, personalised recipe matching, real-time voice guidance, and a feedback loop that gets smarter every meal.</p>
          </div>
          ...
          <div className="hiw-step">
            ...
            <div className="hiw-text">
              ...
              <p>Add what's in your kitchen three ways — type items manually, snap a photo of your fridge or pantry and let our vision model classify everything, or just say it out loud via ElevenLabs voice input. No manual entry required.</p>
            </div>
          </div>
          ...
          <div className="hiw-step hiw-step-rev">
            <div className="hiw-text">
              ...
              <p>AI is good — but you know your kitchen best. Before any recipe is generated, review the detected inventory and correct anything that's off. Tap any item to update quantities or remove it entirely.</p>
            </div>
          ...
          <div className="hiw-step">
            ...
            <div className="hiw-text">
              ...
              <p>Gemini analyses your confirmed ingredients against your personal profile — dietary goals, restrictions, allergies, and past ratings — then proposes 2–4 recipes ranked by how well they fit you right now.</p>
            </div>
          </div>
          ...
          <div className="hiw-step hiw-step-rev">
            <div className="hiw-text">
              ...
              <p>Pick a recipe and let ElevenLabs take over. A warm, natural voice walks you through every prep and cooking step in real time — hands-free, so you can focus entirely on the food.</p>
            </div>
            <div className="hiw-panel hp-midnight">
              <div className="hp-voice-ui">
                <div className="hp-step-label">Step 2 of 6</div>
                <div className="hp-step-text">"Dice the onion and garlic, then heat olive oil in a pan over medium heat..."</div>
                <div className="hp-voice-wave">
                  {[1,2,3,4,5,6,7].map(i => (
                    <span key={i} className="hp-vbar" style={{ animationDelay: `${i * 0.1}s` }}></span>
                  ))}
                </div>
          ...
          <div className="hiw-step">
            <div className="hiw-panel hp-warm">
              <div className="hp-rating-ui">
                ...
                <div className="hp-rating-note">"Great flavour but maybe reduce the garlic next time."</div>
              </div>
            </div>
            <div className="hiw-text">
              <span className="hiw-num">05</span>
              <h3>Rate &amp; Refine</h3>
              <p>After eating, give the recipe a 1–5 star rating and add quick notes. RecipeGen remembers what you loved, what to tweak, and what to never suggest again — getting smarter with every single meal.</p>
            </div>
          </div>
        ...
        <div className="ai-inner">
          ...
          <div className="ai-narrative">
            ...
            <h2 className="ai-title">
              Recipes built around<br />
              exactly what you have.
            </h2>
            <p className="ai-desc">
              Once your inventory is confirmed, RecipeGen sends every authenticated
              ingredient straight to Gemini — alongside your dietary goals, restrictions,
              allergies, and past meal ratings. No guessing. No extra shopping.
              Just recipes that work with your kitchen, right now.
            </p>
      ...
      <section id="nutrition" className="diet-section">
        <div className="diet-inner">
          ...
          <div className="diet-header">
            ...
            <h2 className="diet-title">Every recommendation is built<br />around who you are.</h2>
            ...
            <div className="diet-benefits">
              <div className="db-card">
                ...
                <div>
                  ...
                  <p>Allergens are hard-filtered before Gemini ever sees your inventory. They cannot appear in any suggestion, ever.</p>
                </div>
              </div>
              ...
              <div className="db-card">
                ...
                <div>
                  ...
                  <p>Whether you're building muscle or cutting calories, your macro targets shape the portions and ingredients Gemini chooses.</p>
                </div>
              </div>
              ...
              <div className="db-card">
                ...
                <div>
                  ...
                  <p>Every star rating and note you leave after a meal is fed back into your profile — so future recipes drift toward what you actually love.</p>
                </div>
              </div>
              ...
              <div className="db-card">
                ...
                <div>
                  ...
                  <p>Changed your diet? Going keto? Add, remove, or update any restriction or goal from your profile at any time — changes take effect immediately.</p>
                </div>
              </div>
